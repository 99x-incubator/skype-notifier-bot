...
namespace SkypeBotForCICD
{
    ...
    public class AuthenticationBot : IBot
    {
        ...
        private const string ConnectionName = "Github";

        private const string LoginPromptName = "loginPrompt";
        private const string ConfirmPromptName = "confirmPrompt";

        private const string WelcomeText = @"Hello! I'm SkypeBotForCICD.
                                        Type 'login' to get logged in. Type 'logout' to sign-out.
            ...
            foreach (var member in turnContext.Activity.MembersAdded)
            {
                if (member.Id != turnContext.Activity.Recipient.Id)
                {
                    await turnContext.SendActivityAsync(
                        $"Welcome to SkypeBotForCICD {member.Name}. {WelcomeText}",
